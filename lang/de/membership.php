...
return [
    ...
    'members' => [
        'search' => 'Nach Nummer, Kundschaft oder Mitgliedschaft suchen',
        'title' => 'Mitglieder',
    ...
    'sale' => [
        'already_has_one' => ':client hat bereits eine Mitgliedschaft. Prüfen Sie sie, bevor Sie eine weitere verkaufen.',
        'already_has_this' => ':client hat diese Mitgliedschaft bereits. Prüfen Sie sie, bevor Sie eine weitere verkaufen.',
        'existing_title' => 'Bestehende Mitgliedschaft gefunden',
        'existing_same_title' => 'Diese Kundin oder dieser Kunde hat diese Mitgliedschaft bereits',
        'existing_intro' => 'Es besteht bereits eine Mitgliedschaft. Sie bleibt unverändert — dieser Kauf fügt eine zweite hinzu.',
        'existing_same_intro' => 'Genau diese Mitgliedschaft besteht bereits. Eine weitere wäre eine zweite; sie verlängert oder ersetzt die erste nicht.',
        'existing_buying' => 'Sie verkaufen gleich',
        'existing_remaining' => ':remaining von :granted übrig',
        'existing_expires' => 'Läuft am :date ab',
        'existing_next_billing' => 'Nächste Abrechnung am :date',
        'existing_started' => 'Begonnen am :date',
        'existing_continue' => 'Trotzdem fortfahren',
    ...
    'member' => [
        'drawer' => [
            ...
            'method' => 'Zahlungsart',
            'card' => 'Hinterlegte Karte',
            'included' => 'Enthaltene Leistungen',
            'credit_line' => ':included enthalten · :used genutzt · :remaining übrig',
            'total' => 'Gesamt',
            'cycle_title' => 'Guthaben',
            'cycle' => 'Aktueller Zyklus',
            'renews' => 'Guthaben erneuert sich',
            'expires' => 'Guthaben verfällt',
            'rollover' => 'Nicht genutztes Guthaben wird übertragen',
            'actions' => 'Aktionen',
            'plan_details' => 'Details zum Tarif',
            'view_plan' => 'Tarif ansehen',
        ],
        'title' => 'Mitgliedschaft',
        'none' => 'Kein Mitglied',
