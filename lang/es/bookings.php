...
return [
    ...
    */
    ...
    'purchase' => [
        ...
        'question' => '¿Qué quieres vender?',
        'services' => 'Servicios',
        'services_hint' => 'Una cita: servicios, personal, una hora y una cuenta.',
        'membership' => 'Membresía',
        'membership_hint' => 'Una membresía recurrente o un paquete de servicios.',
        'gift_card' => 'Tarjeta regalo',
        'gift_card_hint' => 'Un saldo que el cliente puede gastar más adelante.',
        'coming_soon' => 'Próximamente',
        'membership_off' => 'Activa primero la membresía en Ajustes de la aplicación.',
        'membership_empty' => 'Publica primero una membresía en Clientes → Membresía.',
    ],

    'membership' => [
        'select' => 'Seleccionar membresía',
        'plans' => 'Planes de membresía',
        'packages' => 'Paquetes de membresía',
        'none' => 'Todavía no hay nada publicado para vender.',
        'none_hint' => 'Publica una membresía en Clientes → Membresía y aparecerá aquí.',
        'includes' => 'Incluye',
        'select_this' => 'Seleccionar membresía',
        'selected' => 'Seleccionada',
        'change' => 'Cambiar',
        'saving' => 'El cliente ahorra :amount',
        'trial' => 'Prueba de :days días',
        'joining_fee' => 'Cuota de alta :amount',
        'setup_fee' => 'Cuota de activación :amount',
        'start' => 'Fecha de inicio',
        'start_today' => 'Empezar hoy',
        'start_later' => 'Elegir una fecha de inicio',
        'start_locked' => 'Las membresías empiezan el día en que se venden.',
        'scheduled_note' => 'Esta membresía estará Programada hasta el :date.',
        'purchase_summary' => 'Resumen de la compra',
        'billing' => 'Cobro',
        'next_billing' => 'Próximo cobro',
        'one_off' => 'Compra única',
        'due_today' => 'Importe a pagar hoy',
        'client_required' => 'Elige primero un cliente: una membresía siempre va asociada a uno.',
        'plan_required' => 'Elige una membresía.',
        'method_note' => 'Una membresía recurrente necesita un método de pago que se pueda volver a cobrar.',
        'complete' => 'Completar compra',
    ],

    'credits' => [
        'available' => 'Ventaja de membresía disponible',
        'from' => 'De :name',
        'remaining' => ':count disponibles',
        'apply' => 'Aplicar crédito de membresía',
        'apply_many' => 'Usar membresía · :count créditos',
        'applied_many' => 'Membresía · :count créditos aplicados',
        'applied' => 'Crédito de membresía aplicado',
        'remove' => 'Quitar',
        'line' => 'Crédito de membresía',
        'covered' => 'Cubierto por la membresía',
        'used_line' => 'Créditos usados',
        'benefits_section' => 'Beneficios de membresía',
        'col_service' => 'Servicio',
        'col_included' => 'Incluido',
        'col_used' => 'Usado',
        'col_remaining' => 'Disponible',
        'covered_by' => 'Cubierto por :name · quedan :count',
    ...
    'cards' => [
        ...
        'save' => 'Guardar esta tarjeta',
        'save_required' => 'Necesaria para la renovación automática de la membresía.',
        'none' => 'Este cliente no tiene ninguna tarjeta guardada.',
        'unavailable' => 'No se pueden guardar tarjetas',
        'unavailable_hint' => 'Conecta una pasarela de pago en Ajustes de la aplicación → Pagos para guardar tarjetas y renovar automáticamente.',
        'client_first' => 'Elige un cliente antes de añadir una tarjeta.',
        'required' => 'Elige una tarjeta para la renovación o desactiva el pago recurrente.',
        'adding' => 'Añadiendo tarjeta…',
        'failed' => 'No se pudo guardar esa tarjeta.',
        'cancel' => 'Cancelar',
        'summary_recurring' => 'Recurrente',
        'summary_payment_method' => 'Método de pago',
        'summary_next_billing' => 'Próximo cobro',
        'yes' => 'Sí',
        'no' => 'No',
    ],
    ...
    'duplicate' => [
        'title' => 'Posible reserva duplicada',
        'title_exact' => 'Parece la misma reserva dos veces',
        'message' => ':client ya tiene :service reservado el :date.',
        'message_overlap' => 'Esto se solapa con una reserva existente del mismo cliente y el mismo servicio.',
        'message_exact' => 'Parece un duplicado exacto de una reserva existente: mismo cliente, mismo servicio, misma sede y misma hora.',
        'existing' => 'Ya reservado',
        'view' => 'Ver la reserva existente',
        'ask' => 'Un cliente puede querer el mismo servicio dos veces en un día. Continúa si es el caso.',
        'continue' => 'Continuar de todos modos',
        'create_anyway' => 'Crear de todos modos',
        'cancel' => 'Cancelar esta reserva',
        'discard_title' => '¿Cancelar esta reserva?',
        'discard_body' => 'Se elimina la reserva que se está creando ahora y el registro de reserva en curso que se ha ido guardando.',
        'discard_keeps' => 'La cita que ya tiene este cliente no se toca.',
        'keep' => 'Mantener la reserva',
        'discard_confirm' => 'Cancelar y eliminar',
        'blocked' => 'Este cliente ya tiene uno de estos servicios reservado ese día. Revisa el aviso en la pantalla de reserva antes de crearla.',
    ],

    'payment' => [
        'deposit_percent' => 'Depósito',
        'deposit_now' => 'A pagar ahora',
        'deposit_now_percent' => 'Depósito del :percent% a pagar ahora',
        ...
        'too_little' => 'Estos servicios exigen un depósito de al menos :amount.',
        'deposit_required' => 'Depósito obligatorio',
        'deposit_required_error' => 'Estos servicios exigen un depósito, así que la reserva no puede crearse sin cobrar nada.',
        'deposit_required_hint' => 'Estos servicios exigen un depósito, así que hay que cobrarlo para completar la reserva. Puede subirse, no quitarse.',
        'deposit_required_percent' => ':percent% del total de la reserva',
        'balance' => 'Pendiente',
    ...
    */
    ...
    'pay' => [
        ...
        'cash_only' => 'Esta reserva tiene precio en efectivo, así que se cobra en efectivo.',
        'cash_only_row' => 'No disponible: esta reserva tiene precio en efectivo.',
    ...
    'email' => [
        ...
        'footer_note' => '¿Necesitas cambiar o cancelar? Responde a este correo o llámanos.',
