...
return [
    ...
    'sale' => [
        'already_has_one' => ':client 已经有会员了。请先查看，再出售另一个。',
        'already_has_this' => ':client 已经有这个会员了。请先查看，再出售另一个。',
        'existing_title' => '发现已有会员',
        'existing_same_title' => '该客户已有这个会员',
        'existing_intro' => '该客户已经有一个会员。它保持不变——这次购买会再加一个。',
        'existing_same_intro' => '客户已经有完全相同的会员。再买一个就是第二个，不会延长或替换第一个。',
        'existing_buying' => '即将出售',
        'existing_remaining' => '剩余 :remaining / :granted',
        'existing_expires' => ':date 到期',
        'existing_next_billing' => '下次扣款 :date',
        'existing_started' => ':date 开始',
        'existing_continue' => '仍然继续',
    ...
    'member' => [
        'drawer' => [
            ...
            'card' => '已存卡',
            'included' => '包含的服务',
            'credit_line' => '含 :included · 已用 :used · 剩余 :remaining',
            'total' => '合计',
            'cycle_title' => '额度',
            'cycle' => '当前周期',
            'renews' => '额度更新',
