    ...
    */
    ...
    'module' => [
        ...
        'workspace' => [
            ...
            'activity' => [
                ...
                */
                'events' => [
                    ...
                    'file_updated' => 'File details changed',
                    'file_replaced' => 'File replaced',
                    'file_deleted' => 'File deleted',
                    'file_viewed' => 'File opened',
                    'file_downloaded' => 'File downloaded',
                    'file_record_created' => 'Before & after recorded',
                    'file_record_updated' => 'Before & after updated',
                    'file_record_deleted' => 'Before & after deleted',
                ],
            ...
            'files' => [
                'title' => 'Files',
                'intro' => 'Consent forms, consultation documents, treatment photos and anything else this client\'s record needs.',
                'private_note' => 'Files on a client are private to your team, and are never used for marketing.',
                'no_access' => 'You do not have permission to see this client\'s files.',
                'add' => 'Add file',
                'draft' => 'Draft',
                'workflow' => [
                    'title' => 'Add file',
                ...
                'draft_saved' => 'Saved as a draft. You can finish it later.',
                'untitled' => 'Untitled treatment',
                'discard_title' => 'Discard changes?',
                'discard_body' => 'What you have entered here is not saved.',
                ...
                'empty' => 'No files on this client yet.',
                'empty_records' => 'No before & after records yet.',
                'empty_hint' => 'Add a consent form, a consultation document or a set of treatment photos.',
                'no_results' => 'No files match what you searched for.',

                'kinds' => [
                    'standard' => 'Standard upload',
                    'standard_hint' => 'A document, an image, or several of them at once.',
                    'record' => 'Before & after',
                    'record_hint' => 'Treatment photos, kept together as one record.',
                ],
                ...
                'fields' => [
                    'name' => 'File name',
                    'name_placeholder' => 'Consent form',
                    'file' => 'File',
                    'files' => 'Files',
                    'note' => 'Note',
                    'note_placeholder' => 'Anything the next person should know about this file.',
                    'category' => 'Category',
                    'service' => 'Service',
                    'booking' => 'Booking',
                    'year' => 'Year',
                    'month' => 'Month',
                    'all_years' => 'Any year',
                    'all_months' => 'Any month',
                    'title' => 'Treatment name',
                    'title_placeholder' => 'Hydrating facial',
                ...
                'drop_images' => 'Drag images here, or',
                'browse' => 'browse',
                'accepted' => 'JPG, PNG, WEBP, PDF, DOC, DOCX, XLS or XLSX.',
                'accepted_images' => 'JPG, PNG or WEBP.',
                'remove' => 'Remove',
                'selected' => '{0} No files chosen|{1} 1 file chosen|[2,*] :count files chosen',
                'images_count' => '{0} No images|{1} 1 image|[2,*] :count images',
                ...
                'actions' => [
                    ...
                    'add_before' => 'Add before images',
                    'add_after' => 'Add after images',
                    'edit_details' => 'Edit treatment details',
                ...
                'viewer' => [
                    ...
                    'no_preview' => 'This file cannot be shown here.',
                    'open' => 'Open file',
                    'information' => 'File information',
                    'empty_side' => 'Nothing on this side yet.',
                ],
                ...
                'confirm_delete_body' => 'It is removed from this client\'s record. The deletion stays in their history.',
                'confirm_delete_record' => 'Delete this before & after record?',
                'confirm_delete_record_body' => 'Every image in it is removed. The deletion stays in this client\'s history.',
                'confirm' => 'Delete',
                'keep' => 'Keep',

                'uploaded' => '{1} File added.|[2,*] :count files added.',
                'updated' => 'File updated.',
                'replaced' => 'File replaced.',
                'deleted' => 'File deleted.',
                'record_saved' => 'Before & after record saved.',
                'record_updated' => 'Before & after record updated.',
                'record_deleted' => 'Before & after record deleted.',

                'name_required' => 'Give this file a name.',
                'file_required' => 'Choose at least one file.',
                'title_required' => 'Give this treatment a name.',
                'record_needs_image' => 'Add at least one before or after image.',
                'failed' => 'That did not save. Try again.',
                'too_large' => ':files is larger than :size and was not added.',

                'recent' => [
                    'title' => 'Recent files',
                    'view_all' => 'View all files',
                    'none' => 'Nothing filed on this client yet.',
                    'latest_treatment' => 'Latest before & after',
                ],
            ],
            'insights' => [
