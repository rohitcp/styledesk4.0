...
return [
    ...
    */
    'new_client' => [
        ...
        'loyalty_enroll' => 'Enrol this client in :program',
        'loyalty_hint' => 'This client can earn points and receive eligible rewards from qualifying visits and purchases.',
        'loyalty_automatic' => 'Every new client joins :program automatically.',
        'loyalty_welcome' => 'Welcome bonus: :points points',
    ...
    */
    ...
    'pay' => [
        ...
        'loyalty_rate' => ':points points = :value',
        'loyalty_available' => ':points points available',
        'loyalty_applied' => 'Reward points (:points)',
        'loyalty_placeholder' => 'Points to use',
        'loyalty_max' => 'Up to :points points on this booking.',
        'loyalty_none' => 'Not enough points available to redeem a reward.',
        'loyalty_capped' => 'Maximum reward value for this booking is :value. Only points up to that amount have been applied.',
        'apply' => 'Apply',
