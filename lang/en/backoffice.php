...
return [
    ...
    */
    ...
    'sms' => [
        'title' => 'SMS',
        'intro' => 'The carrier that carries every business\'s text messages, and the account it is billed to. What a salon sends is its own setting; this is what carries it.',
        'in_effect' => 'In effect now',
        'service' => 'SMS service',
        'enable' => 'Enable StyleDesk SMS',
        'enable_hint' => 'Switched off here, no business on the platform can send a text, whatever their own settings say.',
        'provider' => 'Provider',
        'ready' => 'Ready',
        'not_configured' => 'Not configured',
        'stored' => 'A value is stored. Leave blank to keep it.',
        'not_set' => 'Not set.',
        'testing' => 'Testing',
        'testing_hint' => 'The connection test is a read — no message, no charge — and tells a wrong key from a wrong number. The message test is a real text.',
        'test_connection' => 'Test connection',
        'send_test' => 'Send test SMS',
        'send_to' => 'Send to',
        'saved' => 'SMS settings saved.',
        'connected' => 'The :provider account answered.',
        'not_connected' => 'The :provider account did not answer. Check the credentials.',
        'test_sent' => 'Test message sent to :number via :provider.',
        'test_failed' => 'It could not be sent. :reason',
        'no_reason' => 'The provider gave no reason.',
        'bad_number' => 'That does not look like a phone number.',
        'test_body' => 'StyleDesk SMS test. If you are reading this, the carrier is working.',
        'not_ready' => 'That provider is missing: :fields. Fill them in before switching SMS on.',
        'costs_money' => 'A carrier is connected, so a test message will reach a real phone and be charged for.',
        'local_note' => 'This is a development machine, so nothing reaches a carrier. Messages go to the local SMS inbox instead.',
        'providers' => [
            'telnyx' => 'Telnyx',
            'clicksend' => 'ClickSend',
            'disabled' => 'Disabled',
