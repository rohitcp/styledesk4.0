...
return [
    ...
    'members' => [
        'search' => 'Search by number, client or membership',
        'title' => 'Members',
    ...
    'sale' => [
        'already_has_one' => ':client already holds a membership. Check it before selling another.',
        'already_has_this' => ':client already holds this membership. Check it before selling another.',
        'existing_title' => 'Existing membership found',
        'existing_same_title' => 'This client already has this membership',
        'existing_intro' => 'This client already holds a membership. It stays exactly as it is — this purchase adds a second one.',
        'existing_same_intro' => 'They already hold this exact membership. Another one is a second membership; it does not extend or replace the first.',
        'existing_buying' => 'You are about to sell',
        'existing_remaining' => ':remaining of :granted left',
        'existing_expires' => 'Expires :date',
        'existing_next_billing' => 'Next billing :date',
        'existing_started' => 'Started :date',
        'existing_continue' => 'Continue anyway',
    ...
    'member' => [
        'drawer' => [
            ...
            'credit_line' => ':included included · :used used · :remaining left',
            'total' => 'Total',
            'cycle_title' => 'Credits',
            'cycle' => 'Current cycle',
            'renews' => 'Credits renew',
            'expires' => 'Credits expire',
            'rollover' => 'Unused credits roll over',
            'actions' => 'Actions',
            'plan_details' => 'Plan details',
            'view_plan' => 'View membership plan',
        ],
        'title' => 'Membership',
        'none' => 'Not a member',
    ...
    'form' => [
        ...
        'internal_code_new_hint' => 'Generated by StyleDesk when this is saved. It cannot be changed afterwards.',
