...
@section('title', __('resources.add'))
    ...
    <div class="styledesk_form">
      ...
      <div class="mt-3 flex flex-wrap items-start gap-4">
        <div class="min-w-0 flex-1">
          <h1 class="text-[24px] sm:text-[28px] font-bold text-head tracking-tight">{{ __('resources.add') }}</h1>
        </div>

        <a href="{{ route('resources.index') }}" class="styledesk_action shrink-0">
