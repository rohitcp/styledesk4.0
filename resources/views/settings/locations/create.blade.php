    ...
    <div class="max-w-[760px]">
      ...
      <div class="mt-3 flex flex-wrap items-start gap-4">
        <div class="min-w-0 flex-1">
          <h1 class="text-[24px] sm:text-[28px] font-bold text-head tracking-tight">Add location</h1>
          <p class="text-[14px] text-sub mt-2 leading-relaxed">
            The branch's address, contact details, manager and opening hours. Services, staff assignment
            and booking rules are configured once the location exists.
          </p>
        </div>
