        ...
        [
            ...
            'modules' => [
                ...
                [
                    ...
                    'icon' => 'star',
                    'route' => 'settings.reviews.index',
                    'status' => 'active',
                    'keywords' => ['review', 'feedback', 'rating', 'stars', 'google', 'nps', 'satisfaction', 'complaint'],
                ],
                [
                    'key' => 'client-booking',
                    'name' => 'Client Booking',
                ...
                [
                    ...
                    'icon' => 'gift',
                    'route' => 'settings.loyalty.index',
                    'status' => 'active',
                    'keywords' => ['points', 'reward', 'redeem', 'referral', 'stamp', 'loyalty', 'balance', 'earn'],
                ],
            ],
        ],
        ...
        [
            ...
            'modules' => [
                ...
                [
                    ...
                    'status' => 'active',
                    'keywords' => ['text', 'message', 'mobile', 'phone', 'reminder', 'clicksend', 'opt out', 'reply'],
                ],
            ],
        ],
